                ...
                <div className="col-span-12 xl:col-span-8 bg-slate-50 dark:bg-slate-800/30 rounded-[20px] p-6 flex flex-col overflow-hidden border border-slate-200/60 dark:border-slate-700/50 shadow-inner">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 shrink-0">
                        ...
                        <div className="flex items-center gap-1 p-1 bg-white dark:bg-[#0f172a] rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-x-auto no-scrollbar">
                            ...
                            <button onClick={() => setReceiptSearchClass('Vật tư phụ')} className={`flex-1 py-2 rounded-lg text-[10px] font-bold uppercase transition-all ${receiptSearchClass === 'Vật tư phụ' ? 'bg-rose-500 text-white shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800'}`}>Phụ</button>
                        </div>
                    </div>
                                ...
                                return (
                                    <button key={m.id} onClick={() => {
                                        ...
                                        <div className="min-w-0 w-full">
                                            ...
                                            <span className={`px-1.5 py-0.5 ${m.classification === 'Vật tư chính' ? 'bg-sky-100/50 dark:bg-sky-900/40 text-sky-600 dark:text-sky-400' : 'bg-rose-100/50 dark:bg-rose-900/40 text-rose-500 dark:text-rose-400'} text-[10px] font-bold rounded uppercase inline-block`}>{m.classification === 'Vật tư chính' ? 'Chính' : 'Phụ'}</span>
                                        </div>
