                ...
                <div className="col-span-12 xl:col-span-4 flex flex-col gap-4 overflow-hidden">
                    <div className="bg-slate-50/50 dark:bg-slate-800/20 p-5 rounded-xl border border-slate-200/60 dark:border-slate-700/50 space-y-4">
                        <h3 className="text-sm font-bold text-slate-800 dark:text-white uppercase flex items-center gap-2 mb-2">
                            <ArrowRightLeft size={16} className="text-blue-600" /> Thông tin điều chuyển
                        </h3>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-1.5">
                                ...
                                <select
                                    className="w-full px-3 py-2.5 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-700 rounded-xl font-bold text-sm text-slate-700 dark:text-slate-200 outline-none focus:border-blue-500 transition-all shadow-sm"
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-1.5">
                                ...
                                <input type="text" className="w-full px-3 py-2.5 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-700 rounded-xl font-bold text-sm text-slate-700 dark:text-slate-200 outline-none focus:border-blue-500 transition-all shadow-sm" placeholder="VD: MDH001" value={transferForm.orderCode} onChange={e => setTransferForm({ ...transferForm, orderCode: e.target.value })} />
                            </div>
                            <div className="space-y-1.5">
                                    ...
                                    return (
                                        <div key={idx} className="flex items-center justify-between p-3 bg-white dark:bg-[#1e293b] border border-slate-100 dark:border-slate-700 rounded-xl group hover:border-blue-200 dark:hover:border-blue-700 transition-all">
                                            <div className="min-w-0 flex-1 mr-3">
                                                <p className="text-sm font-bold text-slate-700 dark:text-slate-200 uppercase line-clamp-1 group-hover:text-blue-700 dark:group-hover:text-blue-400">{mat?.name}</p>
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-gradient-to-br from-blue-600 via-blue-600 to-indigo-600 text-white rounded-xl font-extrabold shadow-lg hover:shadow-xl hover:scale-[1.01] active:scale-[0.99] transition-all uppercase tracking-wider text-xs flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                                ...
                                return (
                                    <button key={m.id} onClick={() => {
                                        ...
                                        <div className="flex items-end justify-between mt-auto pt-2 border-t border-slate-50 dark:border-slate-700 w-full">
                                            ...
                                            <div className={`w-7 h-7 rounded-lg flex items-center justify-center transition-all ${isInCart ? 'bg-blue-600 text-white shadow-sm' : 'bg-slate-100 dark:bg-slate-700 text-slate-400 dark:text-slate-500 group-hover:bg-blue-600 group-hover:text-white'}`}>
