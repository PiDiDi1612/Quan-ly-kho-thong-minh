...
import {
    ClipboardList, Search, Plus, Edit2, Trash2, Save, X, AlertTriangle, Package, ExternalLink, ShoppingCart, Check, Download
} from 'lucide-react';
...
export const PlanningEstimates: React.FC<PlanningEstimatesProps> = ({ budgets, projects, materials, transactions, currentUser, onUpdate }) => {
